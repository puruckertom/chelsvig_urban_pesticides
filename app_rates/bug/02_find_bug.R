...
figs <- "C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/figures/"
...
for(i in 1:113){
  ...
  # read in data
  data <- read.csv(file=paste0('C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/output/bug_values_sub', i, '.csv', sep=''))
