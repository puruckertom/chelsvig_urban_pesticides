...
subcatch_areas <- read.table('C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/swmm_sub_list_areas.txt', 
...
subcatch_landuse <- read.csv('C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/sub_list_landuse.csv',sep=",", header=T)



# -----------------------------------------------------------
# read in swmm runoff output (generated in .rpt), units = cms
swmm_rpt_runf <- read.csv('C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/swmm_output_runf.csv',sep=",", header=T)
swmm_rpt_runf <- swmm_rpt_runf[,-1 ]

# read in swmm bif output (generated in .rpt), units = ug/l
swmm_rpt_bif <- read.csv('C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/swmm_output_bif.csv',sep=",", header=T)
...
swmm_conv_runf <- read.csv('C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/swmm_runf_conv_for_vvwm.csv',sep=",", header=T)
swmm_conv_runf <- swmm_conv_runf[,-1 ]

# read in swmm converted bif values (to be input into vvwm), units = g/ha/day
swmm_conv_bif <- read.csv('C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/swmm_bif_conv_for_vvwm.csv',sep=",", header=T)
...
for (sub in 1:113){
  ...
  write.csv(output_df, file=paste0(file='C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/output/', "bug_values_sub", sub, ".csv", sep=""), row.names=F)
...
df <- read.csv(file='C:/Users/echelsvi/git/chelsvig_urban_pesticides/app_rates/bug/output/bug_values_sub85.csv', header=T)
