...
for (o in outfalls){
  ...
  write.table(percentiles, file= paste0(outfall_path,'/percentile_', j, '.txt', sep=''), quote=F, sep=",")
} 
...
perc_conc_h20 <- read.table(paste0(vvwm_path, '/outfall_31_26/percentile_conc_h20.txt', sep=''), sep=",", header=T)
