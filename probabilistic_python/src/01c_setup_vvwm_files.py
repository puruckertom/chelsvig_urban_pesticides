...
logging.info("01c: Looping thru outfalls for navigating to each vwmm folder where its .zts file will be created.")
for o in outfalls:
    # set pathways
    ...
    logging.info("01c: Looking for <runf_for_vvwm_" + o[-5:] + ".csv> and <bif_for_vvwm_" + o[-5:] + ".csv> files and reading to data frames.")
    ...
    # combine
    logging.info("01c: Combining the bif and runf dfs into one and exporting it into a .zts file.")
    ...
    logging.info("01c: Adding 3 blank lines to the top of the .zts file.")
