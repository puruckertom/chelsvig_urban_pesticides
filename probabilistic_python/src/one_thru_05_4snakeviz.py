...
for rpt in range(1, nsims+1):
    ...
    runf_to_conv = save_and_continue(runf_davg, sim_dir + r'\swmm_output_davg_runf.csv')
    ...
    runf_to_conv = save_and_continue(runf_to_conv, sim_dir + r'\swmm_conv_to_vvwm_runf.csv')
    ...
    for o in outfalls:
        ...
        runf_msg = save_and_finish(runf_sub, runf_out)
